...
#  admin_ns="${admin_ns:-kube-system}"
  ...
  output_files=(
    ...
    "policies/mutatingwebhookconfiguration.txt"
  ...
  migration_commands=(
   ...
   kubevirt_output=(
    ...
    "virtualization/storage/cdiconfigs.txt"
    "virtualization/storage/cdiconfigs.yaml"
    "virtualization/storage/cdis.txt"
    "virtualization/storage/cdis.yaml"
...
common_commands_and_files=(
  "get resourcequota -A" "policies/resourcequota.txt"
...
ocp_common_commands_and_files=(
  "get scc" "openshift/ocp_scc.txt"
  "get scc -o yaml" "openshift/ocp_scc.yaml"
  )
